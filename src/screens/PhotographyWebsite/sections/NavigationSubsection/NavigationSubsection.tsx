...
export const NavigationSubsection = (): JSX.Element => {
  ...
  const socialMediaLinks = [
    {
      platform: "Facebook",
      url: "https://www.facebook.com/thanh.quang.208481",
      icon: (
        <svg className="w-8 h-8 text-blue-600 hover:text-blue-700 transition-colors" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      platform: "Instagram", 
      url: "https://www.instagram.com/ongkinhcuaquang_/",
      icon: (
        <svg className="w-8 h-8 text-pink-600 hover:text-pink-700 transition-colors" fill="currentColor" viewBox="0 0 24 24">
